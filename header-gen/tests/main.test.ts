    ...
    const testData: Array<{
    ...
    }> = [
        {
            ...
            expectedC: 'const uint32_t header_data[13] = {\n' +
                       ...
                       '    0x00000000, \n' +
                '};\n',
            expectedDs: 'const headerBlob = hex`4C444F4D31003400FA000000000000044A756D70696E670052756E6E696E67005374616E64696E670057616C6B696E6700000000`;\n',
        }, {
            headerData: {
                samples_length: 80,
            ...
            expectedC: 'const uint32_t header_data[9] = {\n' +
                ...
                '    0x0000656C, \n' +
                '};\n',
            expectedDs: 'const headerBlob = hex`4C444F4D2300240050000000000000035368616B65005374696C6C00436972636C650000`;\n',
    }
